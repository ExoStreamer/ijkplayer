...
long            ijkmp_get_current_audio_pts(IjkMediaPlayer *mp);
long            ijkmp_get_current_video_pts(IjkMediaPlayer *mp);
...
int           ijkmp_get_Bitmap(IjkMediaPlayer* mp,unsigned char** buf);
